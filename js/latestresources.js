async function automateLatestResources() {
    try {
        ...
        if (data.latestVideo) {
            ...
            document.getElementById('latest-video-desc').innerText = data.latestVideo.description || "New lecture available.";
        ...
        if (data.latestPdf) {
            ...
            document.getElementById('latest-pdf-desc').innerText = data.latestPdf.description || "New module available.";
